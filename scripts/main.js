	...
	while (!gameover) {
		...
		switch (morning) {
			...
			case "wake up":
				if (!gameover) {
					alert(
						"You wake up and slowly walk to the washroom, to brush your teeth and get ready."
					);
					...
					} else if (breakfast === "cereal" || breakfast === "bagel" || breakfast ===
						"pancakes" || breakfast === "waffles" || breakfast === "bacon") {
						alert("You finish your " + breakfast +
							" and go back upstairs to brush again.");
					} else {
						gameover = true;
					}
					if (!gameover) {
		...
		if (!gameover) {
			...
			switch (day) {
				...
				case 1:
					alert(
						"You put your stuff in a shared locker with your best friend. You walk inside to see the first two periods are math: your favourie subject!"
					);
					alert("You easily finish the math and do some work on your laptop.");
					alert("*bell rings*");
					alert("Second period, gym!");
					alert(
						"You walk inside the boys changeroom and quickly get dressed for gym.");
					alert(
						"\"LET'S GET INTO A LINE ON THE WALL! WE'RE DOING OUR WARMUP!\" says the gym teacher."
					);
					...
					switch (warmup) {
						case "skip some laps":
							if (Math.random() < 0.75) {
								alert(
									"Your teacher notices and yells at you for cheating. You now have to do a hundred more laps."
								);
								alert("GAME OVER");
								gameover = true;
							} else {
						...
						case "do it all":
							if (breakfast !== "nothing") {
								...
								alert("Your strength increases by 1.");
								//We need to get the strength to increae here
							} else {
				...
				case 2:
					alert(
						"It's Halloween. You put on your brilliant costume, a fedora, and call yourself Winston Churchill."
					);
					classmate = prompt(
						"As you walk to the school building, you see some of your classmates. [Cameron] the Demon, [Daman] the Schoolkid, [Connor] the Leprechaun, and [Harshan] the Zombie.\nDo you greet them or [ignore] them? If you did greet them, which one do you greet?"
					).toLowerCase();
					switch (classmate) {
						case "daman":
							alert("You say, \"Hey Daman. Nice costume.\"");
							alert(
								"He responds, \"I'm not wearing a costume, retard.\" He proceeds to lightly tap your shoulder in a joking way. Being Arshneet, this kills you."
							);
							alert("THE END");
							gameover = true;
							break;
						case "connor":
							...
							alert(
								"Connor responds \"WOW, OF COURSE YOU THINK THE LEPRECHAUN COSTUME IS GOOD: BECAUSE LEPRECHAUNS ARE SHORT AND I'M SHORT!\""
							);
						...
						case "cameron":
							...
							alert(
								"Cameron responds, \"Thanks Arshneet, what are you supposed to...be...\""
							);
						...
						case "harshan":
							...
							alert(
								"He responds, \"Thanks fam. What are you going as when you trick or tre-\""
							);
						...
						case "ignore":
							...
							alert(
								"Walking into homeroom, you look around at the assortment of colors and unique costumes."
							);
							alert("Regardless, you think your costume is the best. Good on you.");
							homeroom = prompt(
								"In homeroom, for the next two periods, do you [work], [fool around], or [play games]?"
							).toLowerCase();
							switch (homeroom) {
								case "fool around":
									alert("Rather than working, you fool around.");
									alert(
										"You play catch with Arash but you drop the ball multiple times and arash makes a joke about it."
									);
									laugh = prompt("Do you laugh at the joke? ([yes] or [no])").toLowerCase();
									switch (laugh) {
										case "yes":
											alert(
												"Your satanic demon laugh invokes the rage of your classmates. They kill you."
											);
											alert("GAME OVER");
											gameover = true;
											break;
										case "no":
											alert(
												"Arash gives you a look for not laughing, but you still continue on to third period."
											);
											break;
									}
									break;
								...
								case "play games":
									...
									alert(
										"Suddenly, because you were so immersed in your Minecraft game, you realize your teacher was watching the whole time."
									);
									alert(
										"Your teacher sends you home as punishment, and your mom grounds you."
									);
									alert("GAME OVER");
									gameover = true;
									break;
							...
							if (!gameover) {
								alert(
									"You enter the gymnasium once again. Warmup was skipped because the volleyball net was up."
								);
								alert(
									"A game of volleyball begins. Daman's legendary overhand serve makes it over the net, with the ball coming straight at you."
								);
								damanserve = prompt(
									"Will you [try to return it], [get out of the way] or [stand in the way]?"
								).toLowerCase();
								switch (damanserve) {
									case "try to return it":
										alert("You wish. This is Daman's serve we're talking about.");
										alert(
											"The ball dunks you with the force of 10,000 Shaquille O'Neals.");
										alert("GAME OVER");
										gameover = true;
										break;
									...
									case "get out of the way":
										...
										alert(
											"Luckily, Harshan, thirsty for redemption after being out-served by Daman, jumps in the way and takes the full force of the hit."
										);
										alert("Point Daman's team.");
										alert(
											"Daman serves again, but Aryaman returns it and scores your team a point."
										);
										alert("Your turn to serve.");
										alert("What technique do you use for your serve?");
										arshserve = prompt(
											"The [Arshneet Sidewinder], [traditional], or the [Daman Punch]?").toLowerCase();
										switch (arshserve) {
											case "daman punch":
											...
											case "arshneet sidewinder":
												alert(
													"You use your signature technique, and get a ball over the net.");
												alert("Doesn't matter though, you still lose.");
												alert(
													"You head home after some more boring work periods, but to you, it's just your normal every day life."
												);
												alert(
													"You eat dinner as usual. No skipping it becuase your parents are watching. After all, you're starving. Boy, is volleyball tiring."
												);
										}
										break;
									default:
				...
				case 3:
					...
					if (readbook === "nothing") {
						...
						alert("After enjoying " + ((readbook === '') ? 'absolutely nothing' :
							readbook) + ", you go down to music.");
						...
						if (frenchlaptop === "bring it") {
							...
							alert(
								"Since Jacob, who sits next to you, is away today, you put it on the chair next to you."
							);
							alert("The strong allure of the laptop is too much for you.");
							alert("You open it up and start playing Minecraft...");
							alert(
								"...only to realize the music teacher was watching the whole time!");
							alert("GAME OVER");
							gameover = true;
							break;
						} else if (frenchlaptop === "leave it") {
							alert(
								"You leave it, telling yourself to deal with the repercussions later."
							);
							alert('You walk to music, and play the bass.');
							alert("Uh oh, time for French...");
							alert(
								"You walk into French. Ms Sheppard notices your lack of device and starts steaming at the ears."
							);
							alert("What's your excuse:");
							frenchexcuse = prompt(
								"[Battery's dead], [forgot], or [didn't think you needed it]?").toLowerCase();
							switch (frenchexcuse) {
								case "battery's dead":
									...
									alert(
										"She says okay, and continues on with class seemingly like normal.");
								...
								case "didn't think you needed it":
									...
									alert(
										"She then commends you on being responsible enough to not have to take your laptop everywhere."
									);
									...
									switch (dramapartner) {
										case "daman":
											...
											alert(
												"You come up with a decent, not good but not bad, presentation.");
			...
			if (!gameover) {
				...
				switch (sleep) {
					case "stay up":
						...
						while (!gameover) {
							...
							if (Math.random() < 0.75) {
								...
								alert(
									"Your mother passes by without blinking an eye. You continue to play video games."
								);
							} else {
					...
					case "go to sleep":
						alert(
							"You bathe, brush your teeth, and finally lie down in bed after a long day."
						);
						break;
					default:
						gameover = true;
